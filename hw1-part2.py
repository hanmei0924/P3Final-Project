...
#
# Note: this is the example we used in class to learn the accumulation pattern
# Try to reconstruct the code here without looking at that code.
...
dogList = ["Akita","Alaskan Malamute","Australian shepherd","Australian cattle dog","Australian Kelpie","Bahuahua","Basset hound","Beagle","Boston terrier","Bulldog","Chihuahua","Cockerspaniel","Collie","French bulldog","English bulldog","Golden Retriever","Great Dane","Maltese","Pomeranian","Poodle","Russell Terrier","Scottish Terrier","Siberian Husky","Shiba Inu","Skye terrier","Smooth Fox terrier","Terrier","Whippet"]
...
# hint: You will need to use if. Also, find() may help again.
