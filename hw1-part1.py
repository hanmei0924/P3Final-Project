...
#a.	Print the first element of otherlst

#b.	Print the last element of lst
...
#c.	Print the contents of s starting from the H

#d.	Print the last four characters of s
